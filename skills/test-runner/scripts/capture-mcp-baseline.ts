...
const OUTPUT_PATH = ".benchmark-input/mcp-baseline.json";
...
async function main(): Promise<void> {
	...
	await mkdir(join(cwd, ".benchmark-input"), { recursive: true });
	await writeFile(join(cwd, OUTPUT_PATH), `${JSON.stringify(artifact, null, 2)}\n`);
	proc.kill("SIGTERM");
