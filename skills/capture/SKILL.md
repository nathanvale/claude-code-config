---
name: capture
description: Capture new information into the shared Memory OS. Use when importing a photo, pasted text, artifact, markdown note, research, review, plan, or real-world event and you want memory output, document output, or both.
...
3. `~/.config/memory/docs/review-note-contract.md`
4. `~/.config/memory/docs/repo-profiles.md`
5. `~/.config/memory/docs/productivity-integration.md`
