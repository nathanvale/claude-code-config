...
Always load:
- `~/code/my-second-brain/context/people/nathan-vale.md`
- target person note at `~/code/my-second-brain/context/people/<slug>.md`
- `@context/contract-perel-baldwin-context.md`

Optional:
- `~/code/my-second-brain/context/context/personal.md`
