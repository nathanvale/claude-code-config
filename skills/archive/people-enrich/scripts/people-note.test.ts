...
const ANDREW_CANDIDATE: IdentityCandidate = {
  title: "Andrew Lazar",
  slug: "andrew-lazar",
  person_id: "person_andrew_lazar",
...
- Existing question`;
  ...
  test("omits empty source_handles when the merged result has no handles", () => {
    const patch = buildPersonPatch({
      person: ANDREW_CANDIDATE,
      updated: "2026-03-22",
      summary: "Old friend since age 17.",
      relationshipBlocks: [
        {
          heading: "Relationship",
          content: "Old friend since adolescence.",
        },
      ],
    });
    ...
    expect(rendered).not.toContain("source_handles:");
