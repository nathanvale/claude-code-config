...
- Use `TASKS.md` in the owning repo by default.
...
- Do not assume the current working directory is always the right owner
...
When external connectors are available, keep using them. Gmail, calendar, knowledge base, and project-tracker sync remain valid sources for task discovery; owner routing only changes where tasks should live.
