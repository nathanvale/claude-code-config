...
export interface OpenApiBaseline {
	...
	contract_id: "bb-pr.openapi-baseline";
...
function validateBaseline(value: OpenApiBaseline): void {
	if (value.contract_id !== "bb-pr.openapi-baseline" || value.schema_version !== "1") throw new Error("OpenAPI baseline contract is unsupported.");
...
function buildIssueDraft(drift: OpenApiDrift, baselineDigest: string, liveDigest: string, fingerprint: string): DriftIssueDraft {
	...
	const lines = [
		...
		"",
		"Generated by `bb-pr doctor openapi`. Review the bounded doctor evidence before accepting a new baseline.",
	];
