 ...
 *
 * Notes:
 * skills/browser-use/scripts/prototype-browser-adapter-map-authoring-workbench/NOTES.md
 */
...
const baseOwners = {
	proof_runtime: "skills/browser-use/scripts/preflight-browser-adapter.ts",
	proof_cli: "skills/browser-use/scripts/preflight-browser-adapter.sh",
	command_contract: "skills/browser-use/scripts/command-contract.ts",
};
