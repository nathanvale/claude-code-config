...
const EXPECTED_STATION_IDS = [
	...
	"sync.vault_git_inputs_required", "sync.vault_git_selected", "sync.vault_git_ssh_prerequisite",
	"sync.vault_git_enrollment_ready", "sync.vault_git_applied", "sync.vault_git_noop",
	"sync.vault_git_selection_blocked", "sync.vault_git_rollback_ready",
	"sync.vault_git_rollback_applied", "sync.vault_git_rollback_blocked",
