...
export const setupBranchStationCatalog = [
	...
	station({ id: "doctor.setup_dependency_unhealthy", command: "doctor", trigger: "dependency hook or runbook check fails", exit: 1, status: "ok", action: "repair_dependency", mutation: readOnly }),
