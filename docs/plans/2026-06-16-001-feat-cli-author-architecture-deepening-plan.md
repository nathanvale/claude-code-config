---
title: "feat: Add cli-author behavior regression package"
type: feat
date: 2026-06-16
origin: docs/brainstorms/2026-06-16-cli-author-architecture-deepening-requirements.md
---

# feat: Add cli-author behavior regression package

## Summary

Implement the `cli-author` architecture-deepening scope as a first-class, agent-native, facade-backed command surface in the `skills/cli-author` package.
...
- Move contract ownership into the `skills/cli-author` package.
...
The current `cli-author` guidance still presents Facade-backed as a lane beside Basic and Agent-native, even though the newer architecture decision treats facade-backed as optional enforcement.
...
- R1. `cli-author` presents Basic CLI and Agent-native CLI as the design-lane decision.
...
- R4. The package owns a catalog of behavior cases for the `cli-author Behavior Regression Check`.
...
- R9. The behavior check is implemented as a facade-backed command in `skills/cli-author`.
...
- R24. V1 keeps runtime schemas, helper signatures, generated envelopes, parser rules, and package command vocabulary out of `cli-author` prose.
...
- **Package-owned command:** `skills/cli-author` already has a Bun package and facade dependency. The behavior check belongs there, not as a standalone shell contract.
...
```mermaid
flowchart TB
  Edit["Edit cli-author guidance"] --> Starter["Shell starter"]
  Starter --> CLI["cli-author behavior-check command"]
...
### U1. Two-step cli-author router

- **Goal:** Update `cli-author` guidance so Facade-backed is enforcement after the Basic vs Agent-native design decision.
...
- **Dependencies:** U1
- **Files:**
  - `skills/cli-author/src/behavior-case-catalog.ts`
  - `skills/cli-author/src/behavior-case-catalog.test.ts`
  - `skills/cli-author/references/behavior-regression-checklist.md`
...
- **Dependencies:** U2
- **Files:**
  - `skills/cli-author/src/command-contract.ts`
  - `skills/cli-author/src/command-contract.test.ts`
  - `skills/cli-author/package.json`
- **Approach:** Add a package command such as `cli-author-behavior-check`. The command supports Markdown and JSON output, a checked-root override, no-input behavior, stable success/failure/usage exits, and structured repair data.
- **Test scenarios:**
...
- **Dependencies:** U3
- **Files:**
  - `skills/cli-author/src/branch-station-catalog.ts`
  - `skills/cli-author/src/branch-station-catalog.test.ts`
...
- **Dependencies:** U2, U3
- **Files:**
  - `skills/cli-author/src/behavior-check-engine.ts`
  - `skills/cli-author/src/behavior-check-engine.test.ts`
...
- **Dependencies:** U3, U5
- **Files:**
  - `skills/cli-author/src/behavior-check-runner.ts`
  - `skills/cli-author/references/check-behavior-regression.sh`
  - `skills/cli-author/package.json`
...
- **Dependencies:** U4, U6
- **Files:**
  - `skills/cli-author/src/behavior-check.integration.test.ts`
  - `skills/cli-author/src/branch-station-catalog.ts`
...
- Update `cli-author` routing language to the two-step design-lane and enforcement-path model.
- Add package-owned behavior case catalog.
- Add facade-backed behavior-check command in `skills/cli-author`.
...
- Prompt-simulation harness for `cli-author`.
- Generated HTML reports.
- Mandatory gate promotion beyond the `cli-author` package.
...
- New ADRs.
- Copying facade runtime contracts into `cli-author` prose.
...
- Origin requirements: `docs/brainstorms/2026-06-16-cli-author-architecture-deepening-requirements.md`
...
- Current checklist: `skills/cli-author/references/behavior-regression-checklist.md`
- Agent-native design owner: `skills/cli-author/references/agent-native-cli-design.md`
- Facade path owner: `skills/cli-author/references/cli-command-facade.md`
- Front-door layout owner: `skills/cli-author/references/cli-front-door-layouts.md`
